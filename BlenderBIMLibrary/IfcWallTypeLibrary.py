...
def create_ifcwalltype_library(ifc_element, ifc_element_type, element_name, ifc_material_layer_set, material_name,classification, item_reference,pset_common, is_external, load_bearing, fire_rating, width, rgb):
...
########################################################
csv_wall_library = "C:\\Algemeen\\00_prive\\BlenderScripts\\BlenderBIMLibrary\\binnenwanden_bibliotheek.csv"
