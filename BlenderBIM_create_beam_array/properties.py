...
class DimensionProperties(bpy.types.PropertyGroup):
    ...
    my_ifcfile:           bpy.props.StringProperty(         name="IFC File Path",
    ...
    my_n: bpy.props.IntProperty(default=5,name="N", step=1, min=2, max=100, update=update_length)
    ...
    my_length: bpy.props.FloatProperty(default=5,name="Length")
